...
\vspace*{-8pt}
\begin{itemize}
\item Working on Bing \textbf{Local Entity Search} as the \textbf{technical lead}, especially on entity understanding by leveraging \textbf{Deep Learning}, search relevance, and large scale data mining and crawling.
\end{itemize} 
\end{position}
