...
\item Built an advanced local entity understanding system by leveraging \textbf{Convolutional Neural Network}, and beat the competitor in our accuracy metrics.
\end{itemize} 
\end{position}
...
\vspace*{-12pt}
\section{\textsc{Award}}
\textbf{Hack Day in Microsoft, China} \hfill Apr. 2013 \\
Category Winner\\
\newline
...
\vspace*{-12pt}
\section{\textsc{Skill}}
\textbf{Programming}: Skilled in Python, and familiar with C++, C\#, Java, and SQL language; Familiar with Speech Technology, Knowledge Graph, Search Engine, Natural Language Processing, and Machine Learning;  \\
\vspace*{-6pt}
\newline
\textbf{Language}: English (fluent), Chinese (native)
